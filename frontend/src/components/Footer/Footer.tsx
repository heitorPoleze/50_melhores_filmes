    ...
    return(
        <footer>
            ...
            <div className={style["center"]}>
               ...
               <a href="https://www.instagram.com/heitor.poleze/" target="_blank" rel="noopener noreferrer"><p>Instagram</p></a> 
            </div>
            <div className={style["right"]}>
                <Botao goto="/about" descricao="Sobre Mim"/>
                <a href="https://github.com/heitorPoleze/50_melhores_filmes" target="_blank" rel="noopener noreferrer">Código Fonte</a>
            </div>
